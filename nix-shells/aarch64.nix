...
pkgs.stdenv.mkDerivation {
  ...
  shellHook = common.shellHook + ''
    ...
    alias vix-build='make MAKE_ARCH=aarch64 CROSS_COMPILE=aarch64-none-elf- -j$NIX_BUILD_CORES && make bootimg-aarch64 MAKE_ARCH=aarch64 CROSS_COMPILE=aarch64-none-elf-'
