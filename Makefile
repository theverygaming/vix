...
img:
	...
	@cat startup/startup kernel/kernel.bin /dev/zero | dd status=none iflag=fullblock of=kernel.bin bs=65536 count=246 # make the shitshell executable land right at KERNEL_FREE_AREA_BEGIN_OFFSET
