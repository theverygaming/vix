...
img-x86:
	...
	@#g++ -m32 -march=i386 -static -static-libgcc -static-libstdc++ -mno-red-zone -fno-pie -fno-stack-protector glibctest.cpp -o glibctest
	@gcc -m32 -march=i386 -static -static-libgcc -mno-red-zone -fno-pie -fno-stack-protector glibctest.c -o glibctest
	@./roramfs_create roramfs.fs "insert fs label here" shitshell/shitshell modules/module.o glibctest fonts/Unifont-APL8x16-15.0.01.psf
