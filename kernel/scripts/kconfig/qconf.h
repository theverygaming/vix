...
public:
    ...
    ConfigItem(ConfigList *parent, ConfigItem *after, bool v) : Parent(parent, after), nextItem(0), menu(0), visible(v), goParent(true) {
        init();
    }
    ~ConfigItem(void);
    void init(void);
...
public:
    ConfigItemDelegate(QObject *parent = nullptr) : QStyledItemDelegate(parent) {}
