...
#define GDT_OFFSET 0x461000

// 80 * 25 * 2 = 4000 bytes, will be 4096 bytes bc it's paged
#define VIDMEM_OFFSET 0x462000

#define KERNEL_START_STACK_POINTER_OFFSET 0x46C000 // stack grows downwards
#define KERNEL_ISR_STACK_POINTER_OFFSET 0x476000

#define KERNEL_FREE_AREA_BEGIN_OFFSET 0x476000
#define KERNEL_MEMORY_END_OFFSET 0x766000
