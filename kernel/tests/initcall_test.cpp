...
DEFINE_INITCALL(INITCALL_PRE_MM_INIT, INITCALL_PRIO_NORMAL, initcall_test_4);
...
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, 2049, initcall_test_8);
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, 123, initcall_test_6);
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, INITCALL_PRIO_NORMAL, initcall_test_7);
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, 2999, initcall_test_9);
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, 1000000, initcall_test_12);
DEFINE_INITCALL(INITCALL_EARLY_DRIVER_INIT, 4000, initcall_test_10);
